...
const UpdateJob = () => {
 ...
 const job = useLoaderData()
    const { job_title, jobBannerUrl, category, description, salary, postingDate, name, email,deadline } = job || {}
    ...
    return (
        ...
        <section className="max-w-4xl p-6 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
          <div className="text-center">
            <h2 className="text-lg font-semibold text-gray-700 capitalize dark:text-white">Update Job</h2>
          </div>
